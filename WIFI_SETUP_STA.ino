void WIFI_SETUP_STA() {
  ...
  if (WiFi.waitForConnectResult() == WL_CONNECTED) {
    ...
    t_httpUpdate_return ret = ESPhttpUpdate.update("https://jramosp91.github.io/HeartFail.ino.INTERATICA19002002.bin", "", "70 0B 6F 62 4F 41 EB 1A 42 3F 73 5A DA 96 98 2D 7F 2B 75 6F");
